...
public class BlackJackRecorder : MonoBehaviour
{
    ...
    string WriteContent()
    {
        ...
        for (int i = 0; i < ClubsPos.Count; i++)
        {
            ...
            + _PracticeSet.SpawnObj_x[0].ToString() + "," + _PracticeSet.SpawnObj_x[1].ToString() + "," + _PracticeSet.SpawnObj_x[2].ToString() + "," + (_PracticeSet.SpawnObjsize_x[0] / 100).ToString() + "," + _PracticeSet.SpawnObjsize_x[1].ToString() + "," + _PracticeSet.SpawnObjsize_x[2].ToString() + ","
            + _PracticeSet.SpawnObj_y1[0].ToString() + "," + _PracticeSet.SpawnObj_y2[0].ToString() + "," + _PracticeSet.SpawnObj_y1[1].ToString() + "," + (_PracticeSet.SpawnObj_y2[1] / 100).ToString() + "," + _PracticeSet.SpawnObj_y1[2].ToString() + "," + _PracticeSet.SpawnObj_y2[2].ToString() + ","
            + _PracticeSet.SpawnObjsize_y1[0].ToString() + "," + _PracticeSet.SpawnObjsize_y2[0].ToString() + "," + _PracticeSet.SpawnObjsize_y1[1].ToString() + "," + _PracticeSet.SpawnObjsize_y2[1].ToString() + "," + (_PracticeSet.SpawnObjsize_y1[2] / 100).ToString() + "," + _PracticeSet.SpawnObjsize_y2[2].ToString() + ","
            + _PracticeSet.SpawnObj_x[3].ToString() + "," + _PracticeSet.SpawnObj_x[4].ToString() + "," + _PracticeSet.SpawnObj_x[5].ToString() + "," + (_PracticeSet.SpawnObjsize_x[3] / 100).ToString() + "," + _PracticeSet.SpawnObjsize_x[4].ToString() + "," + _PracticeSet.SpawnObjsize_x[5].ToString() + ","
            + _PracticeSet.SpawnObj_y1[3].ToString() + "," + _PracticeSet.SpawnObj_y2[3].ToString() + "," + _PracticeSet.SpawnObj_y1[4].ToString() + "," + (_PracticeSet.SpawnObj_y2[4] / 100).ToString() + "," + _PracticeSet.SpawnObj_y1[5].ToString() + "," + _PracticeSet.SpawnObj_y2[5].ToString() + ","
            + (_PracticeSet.SpawnObjsize_y1[3] / 100).ToString() + "," + _PracticeSet.SpawnObjsize_y2[3].ToString() + "," + _PracticeSet.SpawnObjsize_y1[4].ToString() + "," + _PracticeSet.SpawnObjsize_y2[4].ToString() + "," + _PracticeSet.SpawnObjsize_y1[5].ToString() + "," + _PracticeSet.SpawnObjsize_y2[5].ToString() + ","
            + "\n";
        }
        return Content;
    }
    public void ExportCsvInChunks(string baseFileName)
    {
        ...
        for (int startIndex = 0; startIndex < totalCount; startIndex += chunkSize)
        {
            ...
            for (int i = startIndex; i < endIndex; i++)
            {
                ...
                + FirstPressing[i].ToString() + "," + SecondPressing[i].ToString() + "," + ThirdPressing[i].ToString() + "," + FourthPressing[i].ToString() + ","
                + FirstPressingTime[i].ToString() + "," + SecondPressingTime[i].ToString() + "," + ThirdPressingTime[i].ToString() + "," + FourthPressingTime[i].ToString() + "," + Times[i].ToString() + ","
                + BlackGoaled[i].ToString() + "," + RedGoaled.ToString().ToString() + "," //+ _BlackJackManager.hasObstacle.ToString() + ","
        ...
        string content = "hasobstacle,ClubHeartholepos1x,ClubHeartholepos2x,ClubHeartholepos3x,ClubHeartholesize1x,ClubHeartholesize2x,ClubHeartholesize3x,ClubHeartholepos11y,ClubHeartholepos12y,ClubHeartholepos21y,ClubHeartholepos22y,ClubHeartholepos31y,ClubHeartholepos32y,ClubHeartholesize11y,ClubHeartholesize12y,ClubHeartholesize21y,ClubHeartholesize22y,ClubHeartholesize31y,ClubHeartholesize32y,SpadeDiamondholepos1x,SpadeDiamondholepos2x,SpadeDiamondholepos3x,SpadeDiamondholesize1x,SpadeDiamondholesize2x,SpadeDiamondholesize3x,SpadeDiamondholepos11y,SpadeDiamondholepos12y,SpadeDiamondholepos21y,SpadeDiamondholepos22y,SpadeDiamondholepos31y,SpadeDiamondholepos32y,SpadeDiamondholesize11y,SpadeDiamondholesize12y,SpadeDiamondholesize21y,SpadeDiamondholesize22y,SpadeDiamondholesize31y,SpadeDiamondholesize32y,RedGolaedTime,BlackGoaledTime\n"
                           + _BlackJackManager.hasObstacle.ToString() + "," + (_PracticeSet.SpawnObj_x[0] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObj_x[1] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObj_x[2] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObjsize_x[0] / 100).ToString() + "," + (_PracticeSet.SpawnObjsize_x[1] / 100).ToString() + "," + (_PracticeSet.SpawnObjsize_x[2] / 100).ToString() + ","
                + (_PracticeSet.SpawnObj_y1[0]/100-100).ToString() + "," + (_PracticeSet.SpawnObj_y2[0] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObj_y1[1] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObj_y2[1] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObj_y1[2] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObj_y2[2] / 100 - 100).ToString() + ","
                + (_PracticeSet.SpawnObjsize_y1[0] / 100).ToString() + "," + (_PracticeSet.SpawnObjsize_y2[0]/100).ToString() + "," + (_PracticeSet.SpawnObjsize_y1[1] / 100).ToString() + "," + (_PracticeSet.SpawnObjsize_y2[1] / 100).ToString() + "," + (_PracticeSet.SpawnObjsize_y1[2] / 100).ToString() + "," + (_PracticeSet.SpawnObjsize_y2[2] / 100).ToString() + ","
                + (_PracticeSet.SpawnObj_x[3] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObj_x[4] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObj_x[5] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObjsize_x[3] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObjsize_x[4] / 100).ToString() + "," + (_PracticeSet.SpawnObjsize_x[5] / 100).ToString() + ","
                + (_PracticeSet.SpawnObj_y1[3] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObj_y2[3] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObj_y1[4] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObj_y2[4] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObj_y1[5] / 100 - 100).ToString() + "," + (_PracticeSet.SpawnObj_y2[5] / 100 - 100).ToString() + ","
                + (_PracticeSet.SpawnObjsize_y1[3] / 100).ToString() + "," + (_PracticeSet.SpawnObjsize_y2[3]/100).ToString() + "," + (_PracticeSet.SpawnObjsize_y1[4]/100).ToString() + "," + (_PracticeSet.SpawnObjsize_y2[4] / 100).ToString() + "," + (_PracticeSet.SpawnObjsize_y1[5] / 100).ToString() + "," + (_PracticeSet.SpawnObjsize_y2[5] / 100).ToString() + ","
